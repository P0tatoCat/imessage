#!/usr/bin/env bash
#
# Full bridge reset: stop the bridge and wipe ALL local state.
...
echo "  All state wiped — you will need to re-login."
echo ""
echo "  Run 'make install' to reconfigure and start the bridge."
